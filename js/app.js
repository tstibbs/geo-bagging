...
var paths = {
	...
	leaflet_bing: unpkg('leaflet_bing', 'layer/tile/Bing'),
	proj4: unpkg('proj4', 'dist/proj4'),
	...
	file_saver: unpkg('file_saver', 'src/FileSaver'),
	underscore: unpkg('underscore', 'underscore-min'),
